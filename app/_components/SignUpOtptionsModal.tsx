    ...
    <div className="modal text-white">
      <div className="modal-content">
        ...
        <div className="flex flex-col items-center mt-10">
          <button onClick={openSignUpWithEmailModal} className="button border w-[300px] p-2 rounded-full outline-none">Sign up with Email</button>
          <button onClick={signInWithGoogleAccount} className="button border mt-5 w-[300px] p-2 rounded-full outline-none">Sign up with Google</button>
