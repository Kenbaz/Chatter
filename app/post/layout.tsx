...
export default function RootLayout({
  ...
  return (
    ...
    >
      <header className="h-14 dark:bg-primary fixed top-0 z-40 w-full left-0 flex justify-around items-center border border-t-0 border-l-0 border-r-0 border-headerColor">
        <Link href="/feeds">
