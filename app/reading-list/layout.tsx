...
export default function RootLayout({
  ...
  return (
    <div className={`${inter.className} overflow-y-scroll h-screen`}>
      <header className="h-14 dark:bg-primary bg-customWhite3 fixed top-0 z-40 w-full left-0 flex justify-around items-center border border-t-0 border-l-0 border-r-0 dark:border-headerColor">
        <Link href="/feeds">
